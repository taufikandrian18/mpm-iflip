...
{
    public class TBSMUserSiswasUpdateValidator : AbstractValidator<TBSMUserSiswasUpdateDto>
    {
        public TBSMUserSiswasUpdateValidator(
            ...
            IRepository<Sekolahs, Guid> sekolahRepository)
        {
            ...
            RuleFor(x => x.NIS)
                ...
                .Must((x, y) =>
                 {
                     return repository.FirstOrDefault(z => z.NIS == y && z.Id != x.Id && z.DeletionTime == null) == null;
                 })
