...
{
    public class ContentBankAssigneeProofsCreateValidator : AbstractValidator<ContentBankAssigneeProofsCreateDto>
    {
        public ContentBankAssigneeProofsCreateValidator(
