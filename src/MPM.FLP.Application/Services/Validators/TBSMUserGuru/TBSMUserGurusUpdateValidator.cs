...
{
    public class TBSMUserGurusUpdateValidator : AbstractValidator<TBSMUserGurusUpdateDto>
    {
        public TBSMUserGurusUpdateValidator(
            ...
            IRepository<Sekolahs, Guid> sekolahRepository)
        {
            ...
            RuleFor(x => x.NIP)
                ...
                .Must((x, y) =>
                 {
                     return repository.FirstOrDefault(z => z.NIP == y && z.Id != x.Id && z.DeletionTime == null) == null;
                 })
