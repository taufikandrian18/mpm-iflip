...
{
    public class ContentBankCateogriesDeleteValidator : AbstractValidator<ContentBankCategoriesDeleteDto>
    {
        public ContentBankCateogriesDeleteValidator(IRepository<ContentBankCategories, Guid> repository)
        {
            RuleFor(x => x.Id)
