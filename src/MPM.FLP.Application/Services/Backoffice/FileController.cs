...
{
    public class FileController : FLPAppServiceBase, IAzureController 
    {
        ...
        public async Task<string> InsertAndGetUrlAzure(IFormFile file, [FromForm]string id, [FromForm]string nama, [FromForm]string container)
        {
            string url = "";
