...
{
    public class ServiceTalkFlyerController : FLPAppServiceBase, IServiceTalkFlyerController
    {
        ...
        [HttpGet("/api/services/app/backoffice/ServiceTalkFlyer/getAll")]
        ...
        [HttpGet("/api/services/app/backoffice/ServiceTalkFlyer/getByID")]
        public ServiceTalkFlyers GetByIDBackoffice(Guid guid)
        {
            return _appService.GetById(guid);
        }

        [HttpPost("/api/services/app/backoffice/ServiceTalkFlyer/create")]
        public async Task<ServiceTalkFlyers> Create([FromForm]ServiceTalkFlyers model, [FromForm]IEnumerable<IFormFile> files, [FromForm]IEnumerable<IFormFile> documents)
        {
            if (model != null)
            {
        ...
        [HttpPut("/api/services/app/backoffice/ServiceTalkFlyer/update")]
        public async Task<ServiceTalkFlyers> Edit(ServiceTalkFlyers model)
        {
            if (model != null)
            {
                model.LastModifierUsername = "admin";
        ...
        [HttpPut("/api/services/app/backoffice/ServiceTalkFlyer/updateAttachment")]
        public ServiceTalkFlyers EditAttachment([FromForm]Guid Id, [FromForm]IEnumerable<IFormFile> files, [FromForm]IEnumerable<IFormFile> documents)
        {
        ...
        [HttpDelete("/api/services/app/backoffice/ServiceTalkFlyer/destroy")]
        ...
        [HttpGet("/api/services/app/backoffice/ServiceTalkFlyer/getAttachments")]
        public List<ServiceTalkFlyerAttachments> GetAttachments(Guid guid, String attachmentType)
        {
            if (!string.IsNullOrEmpty(attachmentType))
            {
                return _attachmentAppService.GetAll(guid).Where(x => x.FileName.Contains(attachmentType) || x.Title.Contains(attachmentType)).ToList();
            }

            return _attachmentAppService.GetAll(guid).ToList();
        }

        [HttpDelete("/api/services/app/backoffice/ServiceTalkFlyer/deleteAttachment")]
