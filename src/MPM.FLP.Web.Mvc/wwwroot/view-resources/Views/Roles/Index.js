(function () {
	$(function () {
		...
		_$form.find('button[type="submit"]').click(function (e) {
            ...
            var rank = $("#admin option:selected").val();
            role.grantedPermissions.push(rank);
		...
		function deleteRole(roleId, roleName) {
			abp.message.confirm(
                abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'FLP'), roleName),
